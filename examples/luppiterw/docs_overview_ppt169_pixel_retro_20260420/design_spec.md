# docs_overview_ppt169_pixel_retro_20260420 - Design Spec

> This document is the unified handoff artifact for the Pixel Retro Style variant. It keeps the same narrative and slide outline while switching the visual system to the selected template family.

## I. Project Information

| Item | Value |
| ---- | ----- |
| **Project Name** | docs_overview_ppt169_pixel_retro_20260420 |
| **Canvas Format** | PPT 16:9 (1280x720) |
| **Page Count** | 13 |
| **Design Style** | Pixel retro neon deck |
...
- **Style**: Pixel Retro Style
- **Theme**: Dark theme
- **Tone**: consistent with the repository template family `pixel_retro`
...
| **Secondary bg** | `#161B22` | Cards, panels, quiet surfaces |
| **Primary** | `#39FF14` | Titles, key accents, structural highlights |
| **Accent** | `#00D4FF` | Connectors, secondary emphasis |
| **Secondary accent** | `#FF2E97` | Callouts, alternative emphasis |
| **Body text** | `#E6EDF3` | Primary text |
| **Secondary text** | `#8B949E` | Supporting copy |
| **Tertiary text** | `#6E7681` | Footers and low-priority notes |
| **Border/divider** | `#30363D` | Borders and separators |
| **Success** | `#39FF14` | Positive states |
| **Warning** | `#FFD700` | Risks, cautions, issue markers |
...
| **Emphasis** | `"Consolas", "Monaco", "Courier New", monospace` |
