# docs_overview_ppt169_mckinsey_20260420_2 - Design Spec

> This document is the unified handoff artifact for the McKinsey Style variant. It keeps the same narrative and slide outline while switching the visual system to the selected template family.

## I. Project Information

| Item | Value |
| ---- | ----- |
| **Project Name** | docs_overview_ppt169_mckinsey_20260420_2 |
| **Canvas Format** | PPT 16:9 (1280x720) |
| **Page Count** | 13 |
| **Design Style** | McKinsey-style consulting deck |
...
- **Theme**: Light theme
- **Tone**: consistent with the repository template family `mckinsey`
...
| **Secondary bg** | `#ECF0F1` | Cards, panels, quiet surfaces |
| **Primary** | `#005587` | Titles, key accents, structural highlights |
| **Accent** | `#0076A8` | Connectors, secondary emphasis |
| **Secondary accent** | `#F5A623` | Callouts, alternative emphasis |
| **Body text** | `#2C3E50` | Primary text |
| **Secondary text** | `#5D6D7E` | Supporting copy |
| **Tertiary text** | `#7F8C8D` | Footers and low-priority notes |
| **Border/divider** | `#D8E0E5` | Borders and separators |
| **Success** | `#27AE60` | Positive states |
| **Warning** | `#E74C3C` | Risks, cautions, issue markers |
