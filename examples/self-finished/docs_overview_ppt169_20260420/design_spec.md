...
| Item | Value |
| ---- | ----- |
| **Project Name** | docs_overview |
| **Canvas Format** | PPT 16:9 (1280x720) |
| **Page Count** | 13 |
| **Design Style** | General Versatile - tech product launch plus documentation information design |
...
| **Margins** | left/right 52px, top 40px, bottom 34px |
| **Content Area** | 1176x646 inside the safe area |
...
- **Theme**: Light theme
- **Tone**: modern, technical, clean, product-grade, credible

### Color Scheme

> The deck should feel like a product launch presentation for a serious engineering tool. Use blue as the anchor, cyan for system accents, and violet sparingly for emphasis. Keep contrast high and surfaces clean.

| Role | HEX | Purpose |
| ---- | --- | ------- |
| **Background** | `#F7F9FC` | Main page background |
| **Secondary bg** | `#EAF0F8` | Cards, section bands, quiet panels |
| **Primary** | `#1565C0` | Headings, key labels, structural accents |
| **Accent** | `#00ACC1` | Data highlights, connectors, emphasis |
| **Secondary accent** | `#7C4DFF` | Small emphasis, gradient end color |
| **Body text** | `#1F2937` | Primary body text |
| **Secondary text** | `#5B6472` | Captions, helper labels |
| **Tertiary text** | `#8B95A7` | Footers, low-priority notes |
| **Border/divider** | `#D6DEEA` | Card borders and separators |
| **Success** | `#2E7D32` | Positive messages |
| **Warning** | `#D84315` | Risks, caveats, troubleshooting |
...
<radialGradient id="bgDecor" cx="80%" cy="20%" r="50%">
  <stop offset="0%" stop-color="#00ACC1" stop-opacity="0.14"/>
...
> The source content is English-first technical writing. Keep titles assertive and body copy neutral.

**Recommended preset**: P5
...
**Font stack**: `"Arial", "Calibri", "Microsoft YaHei", sans-serif`

### Font Size Hierarchy

> Medium content density. Use compact-but-readable body text so FAQ and setup steps can fit without looking crowded.

**Baseline**: Body font size = 20px

| Purpose | Ratio | Suggested Size | Weight |
| ------- | ----- | -------------- | ------ |
| Cover title | 2.6x | 52px | Bold |
| Chapter title | 2.1x | 42px | Bold |
| Content title | 1.6x | 32px | Bold |
